...
data_folder='C:/Users/Ayoub/Desktop/D'
def load_public_dataset(data_folder=data_folder, tournament='Italy'):
    ...
    matches, events = {}, {}
    with open('C:/Users/Ayoub/Desktop/D/events/events_%s.json' %tournament) as json_data:
        events = json.load(json_data)
    with open('C:/Users/Ayoub/Desktop/D/matches/matches_%s.json' %tournament) as json_data:
    ...
    with open('C:/Users/Ayoub/Desktop/D/players.json') as json_data:
    ...
    competitions={}
    with open('C:/Users/Ayoub/Desktop/D/competitions.json') as json_data:
    ...
    # loading the competitions data
    teams={}
    with open('C:/Users/Ayoub/Desktop/D/teams.json') as json_data:
